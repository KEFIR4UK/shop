    ...
    <div class="product-thumb">
        ...
        <div>
            ...
            <div class="button-group">
                <button type="button" href="<?= Url::to(['/shop/cart/add', 'id' => $product->id]) ?>" data-method="post"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Додати до корзини</span></button>
            </div>
        </div>
    </div>
</div>
